...
theme.fg_normal                                 = "#ccada3"
theme.fg_focus                                  = "#b7afc7"
theme.fg_urgent                                 = "#b7afc7"
theme.bg_normal                                 = "#1a2b3c"
theme.bg_focus                                  = "#1a2b3c"
theme.bg_urgent                                 = "#3e404f"
theme.border_width                              = dpi(0)
theme.border_normal                             = "#b7afc7"
theme.border_focus                              = "#93afac"
theme.border_marked                             = "#859fb5"
theme.taglist_fg_focus                          = "#e09887"
theme.tasklist_bg_focus                         = "#1a2b3c"
theme.tasklist_fg_focus                         = "#e09887"
...
-- Separators
local first = wibox.widget.textbox(markup.font("Ubuntu 9", " "))
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", border_width = 0, screen = s, height = dpi(24), bg = theme.bg_normal, fg = theme.fg_normal })
    ...
    s.mywibox:setup {
		...
		-- bottom = 1, -- don't forget to increase wibar height
		--top = 3,
		--left = 3,
	--right = 3,
    color = "#b7afc7",
